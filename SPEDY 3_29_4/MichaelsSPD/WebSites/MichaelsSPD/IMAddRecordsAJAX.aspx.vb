...
Partial Class IMAddRecordsAJAX
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Select Case task
			...
			Case "vendorisimport"
				'Return a boolean to determine if the vendor is Import or not
				If Session(cUSERID) Is Nothing OrElse Not IsNumeric(Session("UserID")) OrElse Session("UserID") <= 0 Then
					Response.Clear()
					Response.Write(SESSIONEXPIRED)
					Response.End()
				...
				If strTemp.Length > 0 AndAlso IsNumeric(strTemp) Then
					...
					Response.Clear()
					Dim desc As String
					desc = ValidationHelper.IsValidImportVendor(vendorID)
					If desc.Length = 0 Then desc = "False"
					Response.Write(desc)
				Else
