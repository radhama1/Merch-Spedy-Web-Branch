<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POCreationDetailsUploadMMSFile.aspx.vb" Inherits="_POCreationDetailsUploadMMSFile" %>
...
<head id="Head1" runat="server">
    ...
    <title>Item Data Management: Upload</title>
	...
	<div id="sitediv">
		<div id="bodydiv">
			<div id="header">
				...
				<div id="logo"><img src="images/logo.png" width="125" alt="Home" /></div>
				<div id="search">
					&nbsp;
				</div>
				<div class="spacer"></div>
			...
			<div id="content">
				...
				<div id="main" style="text-align:center">
					<div id="">
						<div id="logincontent">
						    <strong>UPLOAD MMS FILE &nbsp;<br /><br /></strong>
		                    ...
		                    <br />
		                    <a href="POCreationDetailsUploadMMSFile.aspx<%=UploadQueryString%>">Try again.</a> &nbsp;<a href="javascript:closewin();">&lt;Close window.&gt;</a>
		                    </asp:Panel>                    		
		                    ...
		                    <br /><br />
		                        <div class="validationDisplay" style="padding: 0px 5px 5px 0px; height: 200px; width:500px; overflow: auto;">
		                            ...
		                            <div id="DiffSKULevelData" runat="server" style="padding-bottom:10px;" visible="false"></div>
		                    ...
		                    <br />
		                        <a href="POCreationDetailsUploadMMSFile.aspx<%=UploadQueryString%>">Cancel.</a> &nbsp;<a href="javascript:closewin();">&lt;Close window.&gt;</a>
		                    </asp:Panel>
		                    <br />&nbsp;
						</div>
					</div>
