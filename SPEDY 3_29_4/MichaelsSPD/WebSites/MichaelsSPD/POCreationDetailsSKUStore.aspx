<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POCreationDetailsSKUStore.aspx.vb" Inherits="POCreationDetailsSKUStore" %>
...
<head id="Head1" runat="server">
    ...
    <title>PO Creation SKU: Quantity Details</title>
    ...
    <script language="javascript" type="text/javascript" src="include/PurchaseOrder/POCreationDetailsSKUStore.js"></script>
	...
	<style type="text/css">
        ...
        .fixedheadercell a, .fixedheadercell a:link, .fixedheadercell a:active, .fixedheadercell a:visited, .fixedheadercell a:hover
        {
            FONT-SIZE: 10pt; 
            width: auto; 
            COLOR: Black; 
                ...
                <tr>
                    <td colspan="2">
                            <table cellpadding="0" cellspacing="0" class="fixedheadertable" width="97%">
                                <tr>
                                    <% If Not(_isSKULocked) Then %><td class="fixedheadercell" style="width:10%" align="center"><asp:Button ID="BtnRemove" runat="server" Text="Remove" class="formButton" Width="65px"/></td><%End If%>
                                    <td class="fixedheadercell" style="width:10%" align="center">Valid</td>
                                    <td class="fixedheadercell" style="width:10%" align="center"><asp:LinkButton ID="BtnSortByStoreNo" runat="server" Text="Store No." /></td>
                                    <td class="fixedheadercell" style="width:30%" align="center"><asp:LinkButton ID="BtnSortByStoreName" runat="Server" Text="Store Name" /></td>
                                    <td class="fixedheadercell" style="width:10%" align="center"><asp:LinkButton ID="BtnSortByZone" runat="server" Text="Zone" /></td>
                                    <td class="fixedheadercell" style="width:30%" align="center">Quantity</td>
                                </tr>
                            </table>
                            <asp:Panel ID="Panel1" runat="server" Height="350px" Width="100%" ScrollBars="Vertical" >
                                <asp:GridView ID="SKUStoreGrid" runat="server" ShowHeader="false" BackColor="#dedede"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <novalibra:NLCheckBox ID="IsRemoved" runat="server" Checked='<% #Eval("IsSelected") %>' Visible='<% #_isRemovable %>'  /></ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Quantity">
                                            <ItemTemplate>
                                                <novalibra:NLTextBox ID="Qty" runat="server" Text='<%#Eval("OrderedQty")%>' RenderReadOnly='<%# _isQtyLocked %>' /></ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Width="29%"  />
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPOLocationID" runat="server" Text='<%#Eval("POLocationID")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
