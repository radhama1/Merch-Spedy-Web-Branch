		...
		function displayMenu()
		{
			...
			else
			{
				if (hoveredItemID > 0)
				{
					...
					document.theForm.selectedItemID.value = selectedItemID;
		...
		function SelectRow(rowID)
		{
			...
			{
				selectedItemID = 0;
				document.theForm.selectedItemID.value = 0;
			}
		}
		...
		function HoverRow(rowID)
		{
			...
			{
				hoveredItemID = rowID;
				document.theForm.hoveredItemID.value = hoveredItemID;
			}
			else
			{
				hoveredItemID = 0;
				document.theForm.hoveredItemID.value = 0;
			}
		}
