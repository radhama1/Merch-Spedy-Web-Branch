			...
			<div id="navigation" name="navigation">
				<table width=100% cellpadding=0 cellspacing=0 border=0>
					<tr bgcolor=333333>
						...
						<td width=100%><img src="./images/spacer.gif" height=1 width=20 border=0><A HREF="user_report.asp" target=_blank><FONT SIZE="1" FACE="Arial" COLOR="white">Export User List</FONT></A><img src="./images/spacer.gif" height=1 width=20 border=0><A HREF="user_department_report.asp" target=_blank><FONT SIZE="1" FACE="Arial" COLOR="white">Export Department List</FONT></A><img src="./images/spacer.gif" height=1 width=20 border=0><%If bIsSystemAdmin Then%><a href="#" onclick="launchNewWin('./security_department_admin/security_department_details_frm.asp', 'Manage_Dept_Sec', 590, 600); return false;"><font size="1" face="Arial" color="white">Manage Department Security</font></a><img src="./images/spacer.gif" height=1 width=20 border=0><%End If%></td>
