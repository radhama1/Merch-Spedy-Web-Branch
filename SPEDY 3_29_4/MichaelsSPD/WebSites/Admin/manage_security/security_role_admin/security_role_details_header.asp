...
<table width=100% cellpadding=0 cellspacing=0 border=0 align=center>
	<tr bgcolor=333333><td colspan=2><img src="../images/editscreen_label_<%if boolIsNew then Response.Write "new" else Response.Write "edit" end if%>role.gif" height=25 width=125 border=0></td></tr>
	<tr>
		<td colspan=2>
