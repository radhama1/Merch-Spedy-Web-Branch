...
<!--border:1px solid dimgray;-->
    <div class="outer">
    <div style="overflow:hidden; width:100%; padding-bottom:3px;">
        <table border="0" cellspacing="0" cellpadding="2" id="tblTitle" style="padding:2px; width:96%; margin-left:1%; margin-right:3%;">
            ...
            <tr >
                <th class="colHeader" width="<%=Col1 %>%">&nbsp;</th>
                <th class="colHeader" width="<%=Col2 %>%">&nbsp;</th>
                <%for c = 0 to numCols-1 %>
                    <th class="colHeader" align="center" id="C<%=c %>" width="<%=colWidth %>%"><%=SmartValues(aFieldCols(dictHeaderDataCols("Category"), c), "String") %></th>
                <%next ' c %>
            </tr>
        </table>
    </div>
