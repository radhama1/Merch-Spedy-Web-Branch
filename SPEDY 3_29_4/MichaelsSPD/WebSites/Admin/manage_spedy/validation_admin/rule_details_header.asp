	...
	<!--
		function preloadImgs()
		{
			...
			{		
				...
				descriptionTabImgOn.src = "../images/tab_details_on.gif";
				descriptionTabImgOff.src = "../images/tab_details_off.gif";
			}
		}
		...
		function initTabs(thisTabName)
		{
			...
			{
				case "descriptionTab":
					parent.frames['body'].rule_description.style.display = "";
...
<table width=100% cellpadding=0 cellspacing=0 border=0 align=center>
	<tr bgcolor=333333><td colspan=2><img src="../images/edit_label_rule_<%if boolIsNew then Response.Write "new" else Response.Write "edit" end if%>.gif" height="25" width="175" border="0"></td></tr>
	<tr>
		<td colspan=2>
			<table width=100% cellpadding=0 cellspacing=0 border=0>
				<tr bgcolor=333333>
					<td><img src="../images/spacer.gif" height=1 width=20 border=0></td>
					<td><a href="javascript: void(0); clickMenu('descriptionTab')"><img name="descriptionTab" id="descriptionTab" src="../images/spacer.gif" height=12 width=100 border=0 alt="manage validation rule details"></a></td>
