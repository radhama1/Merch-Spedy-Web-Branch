<%@ page language="VB" autoeventwireup="false" inherits="SetDeptForExc, App_Web_onmljvps" %>

<%@ PreviousPageType VirtualPath="Workflow_detail.aspx" %> 

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Set Departments For Exception</title>
...
<!--
    ...
    //function closeme()    OnClientClick="javascript:return closeme()"
//{
//   window.close();
//    return true;
//}
...
<body style="background-color:#cccccc; overflow:hidden;" onload="CheckClose();">
    ...
    <div style="">
        ...
        <div style="text-align:center">
            <h3>
                <asp:Label ID="Label1" ForeColor="Navy" runat="server" Text="Select Departments for Exception"></asp:Label>
            </h3> 
        </div>
        <div style="overflow-y:auto; overflow-x:hidden; height:425px; border-style:inset;">
            <asp:CheckBoxList ID="ChbksDeptlist" runat="server" Width = "400px" Font-Size ="10" ></asp:CheckBoxList>
        </div>
