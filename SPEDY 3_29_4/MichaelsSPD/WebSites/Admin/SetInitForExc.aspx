<%@ page language="VB" autoeventwireup="false" inherits="SetInitForExc, App_Web_1xpdmjgj" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Set Initiator Roles For Exception</title>
...
<body style="background-color:#cccccc; overflow:hidden;" onload="CheckClose();">
    ...
    <div style="">
        ...
        <div style="text-align:center">
            <h3>
                <asp:Label ID="Label1" ForeColor="Navy" runat="server" Text="Select Initiator Roles for Exception"></asp:Label>
            </h3> 
        </div>
        <div style="overflow-y:auto; overflow-x:hidden; height:425px; border-style:inset;">
            <asp:CheckBoxList ID="InitiatorRoleList" runat="server" Width = "400px" Font-Size ="10" DataTextField="Group_Name" DataValueField="ID" ></asp:CheckBoxList>
        </div>
