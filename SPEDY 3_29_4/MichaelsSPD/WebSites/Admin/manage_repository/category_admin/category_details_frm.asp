...
Dim categoryID, parentCategoryID
...
<html>
<head>
	<title><%if categoryID > 0 then%>Edit<%else%>New<%end if%> Category</title>
...
<frameset rows="50,1,1,*,1,1,30,0" border="0">
	...
	<frame name="body" src="category_details.asp?cid=<%=categoryID%>&pcid=<%=parentCategoryID%>" scrolling="auto" marginwidth="0" marginheight="0" noresize>
