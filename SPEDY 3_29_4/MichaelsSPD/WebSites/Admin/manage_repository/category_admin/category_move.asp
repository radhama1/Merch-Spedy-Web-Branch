...
<frameset rows="30,1,1,*,1,1,30" border="0">
	<frame name="header" src="category_move_header.asp" scrolling="no" marginwidth="0" marginheight="0" noresize>
	...
	<frame name="body" src="category_move_tree.asp?cid=<%=categoryID%>" scrolling="auto" marginwidth="0" marginheight="0" noresize>
	...
	<frame name="controls" src="category_move_footer.asp" scrolling="no" marginwidth="0" marginheight="0" noresize>
</frameset>
</html>