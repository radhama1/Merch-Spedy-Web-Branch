...
'	on error resume next
	...
	if objDocument is nothing then
		...
		'	on error resume next
			...
			objRootNode.setAttribute("url") = "./website_document_select_details.asp?cid=0&itemType=" & thisElementType & "&itemID=" & thisElementID
		...
		If Err Then 
			...
			if not objRec.EOF then
				...
				Do Until objRec.EOF
					...
					objChildNode.setAttribute("url") = "./website_document_select_details.asp?cid=" & objRec("ID") & "&itemType=" & thisElementType & "&itemID=" & thisElementID
