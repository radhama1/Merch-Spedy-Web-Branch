...
if IsNumeric(categoryID) then
	...
	Response.Redirect "website_category_add.asp?pcid=0"
end if
...
if Request.Form.Count > 0 and len(Request.Form("Category_Name")) > 0 then
	SQLStr = "SELECT * FROM Website_Category WHERE ID = " & categoryID
...
SQLStr = "SELECT Category_Name, Date_Created, Date_Last_Modified FROM Website_Category WHERE ID = " & categoryID
...
<table cellpadding=0 cellspacing=0 border=0 align=center>
	...
	<form name="theForm" action="website_category_edit.asp" method=POST>
	<tr>
		<td colspan=2>
