...
<frameset cols="200,1,*" border="0" topmargin=0 leftmargin=0 rightmargin=0 bottommargin=0 marginheight=0 marginwidth=0>
	...
	<frameset rows="25,4,*" border="0" topmargin=0 leftmargin=0 rightmargin=0 bottommargin=0 marginheight=0 marginwidth=0>
		<frame name="DetailsTabFrame" src="website_details_tabnav.asp?tab=<%=selectedTab%>" scrolling="no" noresize>
		<frame name="blankmargin" src="../app_include/blank_cccccc.html" scrolling="no" noresize>
		<frameset cols="2,*" border="0" topmargin=0 leftmargin=0 rightmargin=0 bottommargin=0 marginheight=0 marginwidth=0>
			<frame name="edge_separator" src="../app_include/blank_cccccc.html" scrolling="no" noresize>
			<frame name="DetailFrameWrapper" src="website_details_frm.asp?tab=<%=selectedTab%>" scrolling="no" noresize>
			<frame name="edge_separator" src="../app_include/blank_cccccc.html" scrolling="no" noresize>
		</frameset>
	</frameset>
</frameset>
