...
Class cls_FilterSet
	...
	Public Function Display()
		...
		If Len(m_FilterHeading) > 0 Then
		
			'Begin Display Header
			Response.Write	"<div class=""FilterSubHeaderText"" style=""width: 100%; float: left;"">" & vbcrlf
		...
		Do Until cellCounter >= (m_NumDisplayPanesPerRow * numRows)
			...
			if curRowNum = 1 Then
				Response.Write	"<td rowspan=" & (numRows * 2) - 1 & " valign=top style=""padding: 0; padding-left: 5px; padding-top: 4px; border-left: 1px solid #ececec;"">" & vbcrlf & _
								...
								"	<input type=hidden name=""excel"" value=""0"">" & vbcrlf & _
								"	<div style=""float: left; width: 100%; padding-top: 8px;""><span class=""formElements"">Save current search as:</span></div>" & vbcrlf & _
								"	<div style=""float: left; width: 100%;""><input type=text name=""Save_Search_Name"" value="""" maxlength=""100"" class=""formElements""></div>" & vbcrlf
				...
				if NOT rs.EOF then
					Response.Write	"	<div id=""Load_Saved_Search_Div"" style=""float: left;"">" & vbcrlf & _
					...
					Response.Write	"	<div id=""Delete_Search_Div"" style=""float: left; margin-left: 5px;"
			...
			if curRowNum <> numRows then
				Response.Write "<tr><td colspan=" & m_NumDisplayPanesPerRow & " style=""border-top: 1px solid #ececec;""><img src=""./images/spacer.gif"" height=""5"" width=""1""></td></tr>" & vbcrlf
			end if
