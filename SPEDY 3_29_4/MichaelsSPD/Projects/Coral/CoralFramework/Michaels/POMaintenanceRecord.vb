Namespace Michaels
    ...
    Public Class POMaintenanceRecord

		Private _id As Long?
		Private _historyId As Long?
		Private _poNumber As Long?
        ...
        Private _isUnrevisable As Boolean?
        ...
        Public Shared Function GetStatusName(ByVal pStatus As Byte) As String

            Select Case pStatus
                Case Status.Worksheet
                    Return "Worksheet"
        ...
        Public Property IsUnrevisable() As Boolean?
            Get
                Return _isUnrevisable
            End Get
            Set(ByVal value As Boolean?)
                _isUnrevisable = value
            End Set
        End Property
