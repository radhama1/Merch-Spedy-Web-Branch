...
var ajaxLookupURL = 'POCreationDetailsAddSKUAJAX.aspx';
...
function SetControls() {
    ...
    if (refresh && windowed) {
        if (refresh.value == "1" && windowed.value == "1") {
            ...
            if (window.parent.opener.document.getElementById('hdnDoNotSaveWorkflowDepartment')) {
                window.parent.opener.document.getElementById('hdnDoNotSaveWorkflowDepartment').value = 1;
            }
