<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BulkItemMaint.aspx.vb" Inherits="BulkItemMaint" %>
...
<head id="Head1" runat="server">
    ...
    <title>Batch Item Maintenance</title>
    ...
    <script language="javascript" type="text/javascript">
        function openBIMUpload() {
            var url = 'UploadBulkItemMaint.aspx?r=1';
            var win = window.open(url, '_BIMuploadWin', 'scrollbars=1,resizable=1,location=0,menubar=0,titlebar=0,toolbar=0,width=600,HEIGHT=600');
            win.focus();
            return false;
        }
        ...
        function ShowHistory(id) {
            ...
            if (window.showModalDialog) {
                ...
                var features = 'height=650,width=950,toolbar=no,directories=no,status=yes,menubar=no,scrollbars=no,resizable=no,modal=yes';
...
<div id="bodydiv" class="margin1" style="width: 100%;">
    ...
    <div class="gridTitle">
        <span class="caption">Bulk Item Maint Batches</span>
        <span class="floatLeft" >&nbsp;&nbsp;&nbsp;&nbsp;
            <a id="lnkUpload" runat="server" href="#" onclick="openBIMUpload();return false;">Upload Bulk Item Maint Spreadsheet</a>
        </span>
        ...
        <asp:GridView ID="gvNewBatches"
            ...
            <Columns>
                <asp:TemplateField  HeaderText="Log ID" SortExpression="0">
                    <ItemTemplate>
                        <a title="Show Batch Details" href="BulkItemMaintItems.aspx?ID=<%#Eval("ID")%>"><%#Eval("ID")%></a><br />
                        <a title="Show Batch Details" href="BulkItemMaintItems.aspx?ID=<%#Eval("ID")%>">Details</a> | <a title="Show History for Batch" href="#" onclick="ShowHistory('<%#Eval("ID") %>'); return false;">History</a>
                    </ItemTemplate>
