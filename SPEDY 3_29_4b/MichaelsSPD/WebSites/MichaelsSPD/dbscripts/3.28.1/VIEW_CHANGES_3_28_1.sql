...
/****** Object:  View [dbo].[vwItemMaintItemDetail]    Script Date: 4/2/2024 7:30:31 AM ******/
SET ANSI_NULLS ON
GO
...
SELECT     I.ID, I.Batch_ID AS BatchID, I.Enabled, I.Is_Valid AS IsValid, SKU.Michaels_SKU AS SKU, CASE WHEN
                      ...
                      SKU.CSA, SKU.UL, SKU.Licence_Agreement AS LicenceAgreement, SKU.Fumigation_Certificate AS FumigationCertificate, SKU.PhytoTemporaryShipment, 
                      ...
                      SKU.STOCKING_STRATEGY_CODE AS STOCKINGSTRATEGYCODE, SKU.POG_Start_Date,
					  V.MinimumOrderQuantity,V.ProductIdentifiesAsCosmetic
...
/****** Object:  View [dbo].[vwItemMaintItemDetailBySKU]    Script Date: 4/2/2024 7:32:14 AM ******/
SET ANSI_NULLS ON
GO
