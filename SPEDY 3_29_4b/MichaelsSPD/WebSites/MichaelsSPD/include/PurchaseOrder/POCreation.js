...
function ShowHistory(id) {
    var now = new Date();
    var url = 'POBatchHistory.aspx?poid=' + id + '&potype=C&tstamp=' + now.getTime()
...
function RemoveDisappr_ActionButtonClick(rowIndex) {
    ...
    if (selvalue == 3) {
        ...
        $('msgPrompt').innerHTML = "<br /><br />Please confirm you want to Remove this Purchase Order from the active batches.";
    ...
    if (selvalue == 2) {
        ...
        $('msgPrompt').innerHTML = "<br />Please enter the reason you are disapproving this PO.";
        ...
        var url = "LookupPODisApproveStages.aspx?POID=" + POID + "&POType=C&StageID=" + StageID
...
var ajaxLookupURL = 'POCreationAjax.aspx';
