...
<head>
	...
	function sortDetails(col_ordinal, sort_direction)
	{
		...
		parent.frames["DetailFrame"].document.location = "website_document_select_finder_results.asp?searchString=<%=searchString%>&searchStatus=<%=searchStatus%>&sort=" + col_ordinal + "&direction=" + sort_direction;
	}
	//-->
	</script>
</head>
