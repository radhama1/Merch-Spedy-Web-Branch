...
SQLStr = "select * from security_user, security_user_group, security_group, security_user_privilege, security_privilege where security_user_group.group_id=security_group.id and security_user_group.[User_id]=security_user.id and security_user_privilege.privilege_id=security_privilege.id and security_user_privilege.[User_id]=security_user.id"
...
%>
	<TR>
		...
		<TD><%=objRec("group_name")%></TD>
		<TD><%=objRec("privilege_name")%></TD>
