...
<html>
<head>
	<title><%if groupID > 0 then%>Edit<%else%>New<%end if%> Role</title>
...
<frameset rows="50,1,1,*,1,1,30,0" border="0">
	...
	<frame name="body" src="security_role_details.asp?gid=<%=groupID%>" scrolling="auto" marginwidth="0" marginheight="0" noresize>
