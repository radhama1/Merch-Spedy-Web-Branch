...
Dim Group_Name, Group_Summary, Is_Role, System_Role
...
<html>
<head>
	<title><%if boolIsNew then%>Add<%else%>Edit<%end if%> Role</title>
	<style type="text/css">
	<!--
...
<table width="100%" cellpadding=0 cellspacing=0 border=0>
	<form name="theForm" action="security_role_details_work.asp" method="POST" onSubmit="doSubmit();">
	...
	<tr bgcolor="cccccc">
		...
		<td width="100%" valign=top>
			...
			if dictDataCols("ColCount") > 0 and dictDataCols("RecordCount") > 0 then
				...
				Is_Role = SmartValues(arDataRows(dictDataCols("Is_Role"), 0), "CBool")
				System_Role = SmartValues(arDataRows(dictDataCols("System_Role"), 0), "CBool")
			end if
			%>
					...
					<tr>
						...
						<td nowrap=true width="100%" valign=top>
							<table cellpadding=0 cellspacing=0 border=0 width="100%">
								...
								<tr>
									<td class="bodyText">Role Name</td>
									<td></td>
									<td><input type="text" size=20 maxlength=500 name="Group_Name" value="<%=Group_Name%>" AutoComplete="off" style="width: 250px;" onBlur="checkRequiredField(this)"></td>
								</tr>
								<tr><td colspan=3><img src="../images/spacer.gif" height=10 width=1 border=0></td></tr>
								<tr>
									<td class="bodyText"valign="top">Role Summary</td>
									<td></td>
				...
				<table width="100%" cellpadding=0 cellspacing=0 border=0>
					<tr>
						...
						<td align=top width="100%">
							<table width=100% cellpadding=0 cellspacing=0 border=0>
								<tr>
									<td class="bodyText" colspan=3 valign=top><b>Permissions</b><%if not System_Role then%>&nbsp;&nbsp;<span style="font-weight: normal; font-size: 10px;">(<a href="" onclick="checkAllByID('strPrivileges','^chkPermissions_'); return false;">Check All</a> | <a href="" onclick="uncheckAllByID('strPrivileges','^chkPermissions_'); return false;">Uncheck All</a>)</span><%end if%></td>
								</tr>
								<tr>
									<td class="bodyText" colspan=3>
										<div class="bodyText" style="background: #fff; border: 0; padding: 10px; padding-top: 0px; height: 370px; width: 100%; clip: auto; overflow: auto;">
											...
											%>
											Permissions can not be modified for this Role.
											<%
											end if
											%>
...
<script language="javascript">
	<!--
		parent.frames["header"].document.location = "security_role_details_header.asp?gid=<%=groupID%>";
		parent.frames["controls"].document.location = "security_role_details_footer.asp?gid=<%=groupID%>";
	//-->
</script>
