...
<head>
	...
	function sortDetails(col_ordinal, sort_direction)
	{
		...
		parent.frames["DetailFrame"].document.location = "validation_doc_list.asp?sort=" + col_ordinal + "&direction=" + sort_direction;
	}
...
<table cellpadding=0 cellspacing=0 border=0>
	<tr>
		<td><img src="./images/spacer.gif" height=1 width=5></td>
		<%=writeColHeader(1, "Workflow", true)%>
		<%=writeSeparatorBar()%>
		<%=writeColHeader(3, "Document", true)%>
		<%=writeSeparatorBar()%>
