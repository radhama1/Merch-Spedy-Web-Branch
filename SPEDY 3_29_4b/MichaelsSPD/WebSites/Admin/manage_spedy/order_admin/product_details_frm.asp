...
Dim productID, parentCategoryID
...
<html>
<head>
	<title><%if productID > 0 then%>Edit<%else%>New<%end if%> Product</title>
...
<frameset rows="50,1,1,*,1,1,30,0" border="0">
	...
	<frame name="body" src="product_details.asp?pid=<%=productID%>&pcid=<%=parentCategoryID%>" scrolling="auto" marginwidth="0" marginheight="0" noresize>
