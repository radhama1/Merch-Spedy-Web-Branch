...
<html>
<head>
	<title><%if Tax_ID > 0 then%>Edit<%else%>New<%end if%> Tax UDA</title>
...
<frameset rows="50,1,1,*,1,1,30,0" border="0">
	...
	<frame name="body" src="tax_details.asp?tid=<%=Tax_ID%>" scrolling="auto" marginwidth="0" marginheight="0" noresize>
