...
<ToolboxData("<{0}:NLCheckBox runat=""server""></{0}:NLCheckBox>")> _
Public Class NLCheckBox
...
#Region "INLChangeControl"
    ...
    Public ReadOnly Property ValueChanged() As Boolean Implements INLChangeControl.ValueChanged
        Get
            Return Boolean.Parse(OriginalValue) <> Checked
        End Get
    End Property
    ...
    Public Sub SetOriginalValue(ByVal value As Object, Optional ByVal setValue As Boolean = True) Implements INLChangeControl.SetOriginalValue
        OriginalValue = value
        If setValue Then Me.Checked = Boolean.Parse(value.ToString())
    End Sub
...
#End Region
    ...
    Protected Overrides Sub Render(ByVal writer As HtmlTextWriter)
        ...
        If RenderReadOnly Then
            ...
            Dim chkstr As String = IIf(Boolean.Parse(Me.Checked), "[x]", "[&nbsp;&nbsp;]")
            writer.Write("&nbsp;" & chkstr)
    ...
    Private Sub NLCheckBox_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
