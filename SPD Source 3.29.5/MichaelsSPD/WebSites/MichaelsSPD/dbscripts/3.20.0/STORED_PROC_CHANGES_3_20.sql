...
-- Description:	Create outbound RMS XML Messages for Item Maintenance based on Batch ID
-- CHANGE LOG:
	NAK 4/2/2013:  Added logic for ExemptEndDateFrench.  If it is specified, send X instead of Y/N to RMS.
-- TEST CODE:
[usp_SPD_ItemMaint_PublishMQMessageByBatchID] @BatchID=51219
-- =============================================
*/
