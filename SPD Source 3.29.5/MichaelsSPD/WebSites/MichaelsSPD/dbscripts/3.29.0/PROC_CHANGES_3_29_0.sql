...
--************************
-- PROC CHANGES FOR 3.29.0
--************************

/****** Object:  StoredProcedure [dbo].[sp_SPD_Batch_PublishMQMessage_ByBatchID]    Script Date: 9/17/2024 2:24:20 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[SPD_Report_CompletedImportItem]    Script Date: 9/17/2024 2:36:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
  ...
  SELECT  ii.ID, ii.Batch_ID, ii.DateCreated, ii.DateLastModified, 		
	  ...
	  COALESCE(lv.Display_Text, '') as Private_Brand_Label, ii.QuoteReferenceNumber, ii.Customs_Description,  --ii.MinimumOrderQuantity, ii.VendorMinOrderAmount as MinimumOrderAmount, 
	  ii.ProductIdentifiesAsCosmetic,
...
BEGIN
	...
	SELECT simi.ID, simi.Batch_ID, simi.Date_Created, b.Date_Modified, 
		...
		s.CoinBattery, --s.TSSA, 
		s.CSA, s.UL, s.Licence_Agreement, s.Fumigation_Certificate as PhytoSanitaryCertificate,s.PhytoTemporaryShipment, s.KILN_Dried_Certificate, s.China_Com_Inspec_Num_And_CCIB_Stickers,
		...
		s.QuoteReferenceNumber as Quote_Reference_Number, s.Customs_Description, --v.MinimumOrderQuantity, v.Vendor_Min_Order_Amount as MinimumOrderAmount, 
		v.ProductIdentifiesAsCosmetic,
...
/****** Object:  StoredProcedure [dbo].[SPD_Report_ImportItem]    Script Date: 9/17/2024 2:38:12 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	SELECT  ii.ID, ii.Batch_ID, ii.DateCreated, b.Date_Modified, 
		...
		ii.HazMatContainerType, ii.HazMatMFGState, ii.HazMatContainerSize, ii.HazMatMFGPhone, ii.HazMatMSDSUOM, ii.CoinBattery, --ii.TSSA, 
		ii.CSA, ii.UL, ii.LicenceAgreement,     
...
/****** Object:  StoredProcedure [dbo].[usp_SPD_ItemMaint_CompleteOrErrorBatch]    Script Date: 9/17/2024 2:41:08 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
9/17/2024 - MWM: remove gtin functionality
-- =============================================
*/
...
/****** Object:  StoredProcedure [dbo].[usp_SPD_ItemMaint_ProcessIncomingMessage]    Script Date: 9/17/2024 2:42:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[usp_SPD_ItemMaint_PublishMQMessageByBatchID]    Script Date: 9/17/2024 2:50:01 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[usp_SPD_MQComm_UpdateItemMaster]    Script Date: 9/17/2024 2:52:58 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[usp_SPD_MQComm_UpdateItemMaster_BySKU]    Script Date: 9/17/2024 2:53:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[usp_SPD_UpdateNewItemFromIM]    Script Date: 9/17/2024 2:55:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[usp_SPD_Validation_ValidateImportItem]    Script Date: 9/17/2024 2:57:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[usp_SPD_Validation_ValidateItem]    Script Date: 9/17/2024 2:59:06 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[usp_SPD_Validation_ValidateItemMaintItem]    Script Date: 9/17/2024 3:00:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
