<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UploadItemMaint.aspx.vb" Inherits="UploadItemMaint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Import for Item Maintenance</title>
		...
		<div id="bodydiv">
			...
			<div id="content">
				...
				<div id="main" style="text-align:center">
					<div id="">
						<div id="logincontent">
						<strong>UPLOAD ITEM MAINTENANCE SPREADSHEET &nbsp;<br /><br /></strong>
		                ...
		                <asp:Panel ID="panelButtons" runat="server" style="padding: 20px;" Visible="false">
	                        ...
	                        <asp:Button ID="btnConfirm" runat="server" Text="Create Partial Batch" Visible="false" CssClass="formButton" />
