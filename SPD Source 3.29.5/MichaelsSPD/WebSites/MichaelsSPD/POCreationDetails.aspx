<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POCreationDetails.aspx.vb" Inherits="POCreationDetails" MaintainScrollPositionOnPostback="true" %>
...
<head>
	...
	<script language="javascript" type="text/javascript" src="include/PurchaseOrder/POCreationDetails.js"></script>
	...
	<!--
		...
		{
			var win = window.open('mockup2.htm','skudetails','scrollbars=0,location=0,menubar=0,titlebar=0,toolbar=0,width=500,HEIGHT=500');
			return false;
			//document.location = 'detailexport.aspx?hid=2507';
			//return false;
		}
		*/
		...
		function cancelForm()
		{
		   if(PromptToSave()) {
		        if(confirm('Are you sure you want to exit the page without saving?')){
		            window.location.href = 'POCreation.aspx';
		        }
		   }
		   else {
                window.location.href = 'POCreation.aspx';
		...
		function SaveSKUDefaultsUPC(SKU, field, refresh)
		{
			...
			var url = "POCreationDetailsUpdSKUsGrid.aspx";
		...
		function ShowProcessing() {
			...
			divProcessing.style.top = divContent.style.top;
			divProcessing.style.left = divContent.style.left;
			divProcessing.style.backgroundColor = "#FFFFFF";
		...
		function DisplayOverlay() 
		{
			...
			togglePopup('SKUUpdateContent', 'block', 'visible');
        ...
        function OpenAddSKU() 
        {
            ...
            if (isDirty.value == "1") {
                ...
                OpenNewPopupWindow('POCreationDetailsAddSKU.aspx?POID=<%=Request("POID")%>', 'AddSKU', 1000, 750);                
            }
        }

        function OpenImportExcelPOFile() 
        {            
            var isDirty = $('hdnPageIsDirty');
            ...
            if (isDirty.value == "1") {
               ...
               //Open Window On Next Load
                $('hdnOpenPopup').value = 'UPLOADEXCELFILE';
                
                //Save Current Cache
                SaveCache();
            }
            else {
                OpenNewPopupWindow('POCreationDetailsUploadPOFile.aspx?POID=<%=Request("POID")%>', 'UploadFile', 1000, 550);
            }
        }
        
        function OpenImportMMSFile() 
        {           
            var isDirty = $('hdnPageIsDirty');
            ...
            if (isDirty.value == "1") {
                ...
                //Open Window On Next Load
                $('hdnOpenPopup').value = 'UPLOADMMSFILE';

                //Save Current Cache
                SaveCache();
            }
            else {
                OpenNewPopupWindow('POCreationDetailsUploadMMSFile.aspx?POID=<%=Request("POID")%>', 'UploadFile', 1000, 550);
            }
        }

        function ShowPOCreationDetailsSKUStore(poID, SKU) 
        {
		    var isDirty = $('hdnPageIsDirty');
            ...
            if (isDirty.value == "1") {
                ...
                $('hdnQueryStrValue').value = '&SKU=' + SKU;
		        ...
		        OpenNewPopupWindow('POCreationDetailsSKUStore.aspx?POID=' + poID + '&SKU=' + SKU, 'SKUStore', 1000, 750);
		    }
		}
...
//		    }
        ...
        function PageSetup() {
		    ...
		    switch(popupWindow)
		    {
		        ...
		        case "ADDSTORE":
		            OpenNewPopupWindow('POCreationDetailsSKUStore.aspx?POID=<%=Request("POID")%>' + $('hdnQueryStrValue').value, 'SKUStore', 1000, 750);
		            break;
		...
		function SaveCache() {
		    ...
		    frmPOCreationDetail.action = "POCreationDetails.aspx?POID=" + poID + "&RELOAD=N";
		...
		{
		    var poID = getQuerystring("POID");
		    document.location = "POCreationDetails.aspx?POID=" + poID + "&RELOAD=N";
		}
...
<form id="frmPOCreationDetail" runat="server" defaultbutton="btnUpdate">
	<div id="sitediv">
		<div id="bodydiv">
			<div id="header">
										        ...
										        <tr>
				                                    <td id="POHeaderTab" runat="server" width="110" height="27"  align="right" valign="bottom">
				                                        <asp:LinkButton id="POHeaderLink" runat="server" CssClass="tabPOText" Text="PO Header" Width="109" Height="20" OnClientClick="javascript:return ValidateAndWait();">
				                                            <img runat="server" id="POHeaderImage" src="images/spacer.gif" alt="" style="padding-left:8px;" width="11" height="11" border="0" />
				                                        </asp:LinkButton>
											        </td>
				                                    <td id="PODetailTab" runat="server" valign="bottom" align="right" width="100" height="27">
			                                            <asp:LinkButton ID="PODetailLink" runat="server" CssClass="tabPOTextActive" Text="PO Detail" Width="109" Height="20" Enabled="false">
			                                                <img runat="server" id="PODetailImage" src="images/spacer.gif" alt="" style="padding-left:8px;" width="11" height="11" border="0" />    
			                                            </asp:LinkButton>
				                                    </td>				                            
				                                </tr>
				                            </table>
                                        ...
                                        <td id="validationDisplayTD" style="width: 100%;">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                                <Triggers>
                                                    ...
                                                    <asp:AsyncPostBackTrigger ControlID="btnRemoveCheckedSKUs" />
                                                    <asp:AsyncPostBackTrigger ControlID="btnTotalSyncCheckedSKUs" />
                                                </Triggers>
                                                <ContentTemplate>
								            ...
								            <table cellpadding="0" cellspacing="0" border="0" class="whiteText" width="100%">
										        <tr>
											        ...
											        <td class="whiteText" style="padding-left: 15px;">
												        Workflow Department:&nbsp;
												        <asp:DropDownList ID="WorkFlowDept" runat="server" onChange="javascript:setPageAsDirty()" />
											        </td>
											        <td class="formField whiteText" style="padding-left: 15px;">
												        PO Department:&nbsp;
								        ...
								        <td colspan="2">
								            <div id="divSummary">
										        <table cellpadding="5" cellspacing="0" border="0" >
											        <tr>
												        <td valign="top" >
													        <table runat="server" name="tblAllocationsTotals" id="tblAllocationsTotals" cellpadding="2" cellspacing="0" border="0" ></table>
												        </td>
											        </tr>
										        </table>
									        </div>
				                                    ...
				                                    <td style="height: 22px; white-space: nowrap;" valign="middle" align="left" nowrap="nowrap">                                                
												        <%
													        ...
													        %>
														        ...
														        <div style="white-space: nowrap; float: left;"><a href="#" onclick="OpenImportExcelPOFile(); return false;">Import Excel PO File</a>&nbsp;</div>
														        <asp:Panel ID="MMSFileDiv" style="white-space: nowrap; float: left;" runat="server" Visible="false"><a href="#" onclick="OpenImportMMSFile(); return false;">Import MMS File</a></asp:Panel>
													        <%
													        End If
												        %>
                                                    </td>
											        ...
											        <td>
											            <div id="skugrid">
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>                                                                
                                                                        <novalibra:NLCheckBox ID="IsChecked" runat="server" Visible='<%# Not _isSKULocked %>' />
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="1%" />
                                                                    <HeaderTemplate>
                                                                ...
                                                                <asp:TemplateField SortExpression="Is_Valid">
                                                                    <ItemTemplate>
                                                                        <img src="<%# GetCheckBoxUrl(Eval("Is_Valid")) %>" alt="" /></ItemTemplate>
                                                                    <ItemStyle Width="1%" />
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="VPN" SortExpression="VPN">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblVPN" runat="server" Text='<%# Eval("VPN") %>' /></ItemTemplate>
                                                                    <ItemStyle Wrap="true" Width="6%" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="UPC" SortExpression="UPC">
                                                                    <ItemTemplate>
                                                                        <novalibra:NLDropDownList ID="ddlUPC" runat="server" AppendDataBoundItems="true"
                                                                            SelectedValue='<%# Bind("UPC") %>' DataTextField="UPCText" DataValueField="UPCVal"
                                                                            DataSource='<%# GetSKUUPCs(Eval("Michaels SKU"), Eval("UPC")) %>' RenderReadOnly='<%# _isUPCLocked %>'
                                                                            onChange="javascript:setPageAsDirty()" />
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="15%" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField Visible="false">
                                                                ...
                                                                <asp:TemplateField HeaderText="Desc" SortExpression="Item_Desc">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblDesc" runat="server" Text='<%# Eval("Item_Desc") %>' /></ItemTemplate>
                                                                    <ItemStyle Width="20%" />
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Unit Cost" HeaderStyle-CssClass="gvnumbers" SortExpression="Unit_Cost">
                                                                    <ItemTemplate>
                                                                        <novalibra:NLTextBox ID="txtUnitCost" runat="server" Text='<%# Eval("Unit_Cost") %>'
                                                                            Width="50px" RenderReadOnly='<%# _isUnitCostLocked%>' onChange="javascript:setPageAsDirty()" /></ItemTemplate>
                                                                    <ItemStyle Width="7%" HorizontalAlign="Right" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="RMS <BR/> Unit Cost" HeaderStyle-CssClass="gvnumbers"
                                                                    SortExpression="RMS_Cost">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblRMSUnitCost" runat="server" Text='<%# Eval("RMS_Cost")%>' Width="45px"
                                                                            CssClass="gvnumbers" onChange="javascript:setPageAsDirty()" /></ItemTemplate>
                                                                    <ItemStyle Width="7%" HorizontalAlign="Right" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="IP" HeaderStyle-CssClass="gvnumbers" SortExpression="Inner_Pack">
                                                                    <ItemTemplate>
                                                                        <novalibra:NLTextBox ID="txtIP" runat="server" Text='<%# Eval("Inner_Pack")%>' Width="35px"
                                                                            RenderReadOnly='<%# _isIPLocked%>' onChange="javascript:setPageAsDirty()" /></ItemTemplate>
                                                                    <ItemStyle Width="5%" HorizontalAlign="Right" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="RMS IP" HeaderStyle-CssClass="gvnumbers" SortExpression="RMS_Inner_Pack">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblRMSIP" runat="server" Text='<%# Eval("RMS_Inner_Pack")%>' Width="35px"
                                                                            CssClass="gvnumbers" /></ItemTemplate>
                                                                    <ItemStyle Width="5%" HorizontalAlign="Right" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="MC" HeaderStyle-CssClass="gvnumbers" SortExpression="Master_Pack">
                                                                    <ItemTemplate>
                                                                        <novalibra:NLTextBox ID="txtMC" runat="server" Text='<%# Eval("Master_Pack") %>'
                                                                            Width="35px" RenderReadOnly='<%# _isMasterPackLocked%>' onChange="javascript:setPageAsDirty()" /></ItemTemplate>
                                                                    <ItemStyle Width="5%" HorizontalAlign="Right" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="RMS MC" HeaderStyle-CssClass="gvnumbers" SortExpression="RMS_Master_Case">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblRMSMC" runat="server" Text='<%# Eval("RMS_Master_Case")%>' Width="35px"
                                                                            CssClass="gvnumbers" /></ItemTemplate>
                                                                    <ItemStyle Width="5%" HorizontalAlign="Right" />
                                                                </asp:TemplateField>
                                                            </Columns>
												        ...
												        <table runat="server" id="tblTmpFooter" cellpadding="2" cellspacing="0" border="0" width="100%" style="border:1px solid silver">
												            ...
												            <td class="formLabel subHeading" >
													                <table border="0" cellpadding="5" cellspacing="0" width="100%" runat="server" id="tblSKUsFooter">
													                    <tr>
													                        <td style="text-align:left"><asp:Button ID="btnRemoveCheckedSKUs" runat="server" Text="Remove Checked" OnClientClick="javascript:return ValidateDeleteSKUs();" CssClass="formButton" /> </td>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td width="50%" style="width: 50%;" align="left" valign="top">
                                                        <input type="button" id="btnCancel" onclick="cancelForm(); return false;" value="Cancel"
                                                                    class="formButton" />&nbsp;
                                                    </td>
                                                    <td width="50%" style="width: 50%;" align="right" valign="top">
                                                                &nbsp;<asp:Button runat="server" ID="btnUpdate" Text="Save" CssClass="formButton"
                                                                    OnClientClick="javascript:return ValidateDateControls();" />
                                                                &nbsp;&nbsp;<asp:Button runat="server" ID="btnUpdateClose" Text="Save &amp; Close"
                                                                    CssClass="formButton" OnClientClick="javascript:return ValidateDateControls();" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </th>
    ...
    <asp:HiddenField runat="server" ID="hdnDoNotSaveWorkflowDepartment" Value="" />
