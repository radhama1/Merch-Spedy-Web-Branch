...
<head>
	...
	<script language="javascript">
		...
		var ParentFramesetName			= "MainDetailFrame";			// id assigned to frameset
		var FramesetType				= "rows";						// rows or cols
		<%If enumerateUserGroup Or enumerateUserRole Then%>
		var DimensionsPrefixString		= "15,";						// string to precede the filter frame dimension
		var DimensionsSuffixString		= ",1,15,*,20";					// string to follow the filter frame dimension
		<%Else%>
		var DimensionsPrefixString		= "1,";							// string to precede the filter frame dimension
		var DimensionsSuffixString		= ",15,*,20";					// string to follow the filter frame dimension
		<%End If%>
