...
<head>
	...
	<!--
		...
		{
		    var success = false;   
		    if (document.theForm.Is_Vendor.value == "1") {
		        if (checkRequiredField(document.theForm.UserName) && checkRequiredField(document.theForm.Email_Address))
			    {
			        success = true;
	...
	<tr bgcolor="cccccc">
		...
		<td width="100%" valign=top>
			...
			if dictContactDataCols("ColCount") > 0 and dictContactDataCols("RecordCount") > 0 then
				...
				Enabled = CBool(SmartValues(arContactDataRows(dictContactDataCols("Enabled"), 0), "cLng"))
				...
				Language_ID = SmartValues(arContactDataRows(dictContactDataCols("Language_ID"), 0), "cLng")
				...
				'Primary_Approver = CBool(SmartValues(arContactDataRows(dictContactDataCols("Primary_Approver"), 0), "Integer"))
				' Is_Vendor
				Is_Vendor = SmartValues(arContactDataRows(dictContactDataCols("Is_Vendor"), 0), "CBool")
			end if
			%>
			<input type="hidden" id="Is_Vendor" name="Is_Vendor" value="<%if Is_Vendor = true then Response.Write("1") else Response.Write("0") end if%>" />
					...
					<tr>
						...
						<td nowrap=true width="100%" valign=top>
							<table cellpadding=0 cellspacing=0 border=0 width="100%">
								...
								<!--<tr>
									<td class="bodyText">Primary Approver</td>
									<td></td>
									<td><input type="checkbox" name="PrimaryApprover" value="1"<%if Primary_Approver then Response.Write " CHECKED"%>></td>
								</tr> -->
								<tr>
						...
						%>
								...
								<tr>
									...
									<td></td>
									<td><input type="text" size=20 maxlength=500 name="Department" value="<%=Department%>" AutoComplete="off" style="width: 250px;" readonly="true"></td>
								</tr>
								<tr>
