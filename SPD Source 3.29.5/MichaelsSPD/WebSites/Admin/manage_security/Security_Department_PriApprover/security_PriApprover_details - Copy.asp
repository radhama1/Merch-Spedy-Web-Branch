...
<head>
    ...
    function GetUsers() {
        ...
        if (currentDeptValue == 0) {     // clear out User div
        ...
        lblDeptTitle.innerHTML = "Select Primary Approvers for Deptartment: "
        ...
        <table border="0" cellspacing="0" id="Table2" style="padding:4px; width:100%;">
            <tr>
                ...
                <td align="left" width="88%">
                    ...
                    <%Do While not rs.EOF %>
                        <option value='<%=SmartValues(rs("ID"), "CStr") %>'><%=Server.HTMLEncode(SmartValues(rs("Privilege_Name"), "CStr")) %></option><%rs.MoveNext
                      loop
                      rs.close()
                      Set rs = Nothing
                     %>
