...
<html>
<head>
	<title>Group Security Frameset</title>
	<style type="text/css">
	<!--
		BODY
		{
...
<frameset rows="*<%if showUserList and selectedGroupID > 0 then Response.Write ",200" end if%>" framespacing=2 border="0" topmargin=0 leftmargin=0 rightmargin=0 bottommargin=0 marginheight=0 marginwidth=0>
	<frameset rows="1,16,*" framespacing=0 border="0" topmargin=0 leftmargin=0 rightmargin=0 bottommargin=0 marginheight=0 marginwidth=0 frameborder=no>
		...
		<frame name="GroupDetailFrame" src="security_group_details.asp" scrolling="yes" frameborder=no><!-- Security Detail View Content -->
	</frameset>
<%
if showUserList and selectedGroupID > 0 and listType = 1 then
%>
	<frame name="UserList" src="security_user_details_frm.asp?enumgroup=1&enumrole=0&sgid=<%=selectedGroupID%>" scrolling="no" frameborder=yes>
<%
end if
%>
</frameset>
