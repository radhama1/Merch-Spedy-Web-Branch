	...
	<!--
		...
		function saveOnly()
		{
			if (confirm("Really apply these changes?\n\nThis cannot be undone."))
			{
				...
				parent.frames['body'].document.theForm.action = "website_document_details_work_noclose.asp";
				...
				parent.frames['body'].document.theForm.action = "website_document_details_work.asp";
