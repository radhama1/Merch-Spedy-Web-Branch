...
<html>
<head>
	<title>Web Document Display Settings</title>
...
<frameset rows="50,1,1,*,1,1,30,0" border="0">
	...
	<frame name="body" src="website_document_details.asp?tid=<%=elementID%>" scrolling="auto" marginwidth="0" marginheight="0" noresize>
