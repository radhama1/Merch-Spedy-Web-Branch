...
<frameset rows="1,20,*,20" frameborder=0 border="0" topmargin=0 leftmargin=0 rightmargin=0 bottommargin=0 marginheight=0 marginwidth=0>
	...
	<frame name="DetailFrame" src="website_document_select_details.asp?cid=0&itemType=<%=thisElementType%>&itemID=<%=thisElementID%>" scrolling="yes" noresize><!-- Detail View Content -->
