...
<table width=100% cellpadding=0 cellspacing=0 border=0>
	...
	<tr>
		...
		'	Response.Write SQLStr
			...
			<!--
				parent.frames["DetailFrameHdr"].document.location = "website_document_swap2_finder_results_header.asp?searchString=<%=searchString%>&searchStatus=<%=searchStatus%>&sort=<%=SortColumn%>&direction=<%=SortDirection%>";
			//-->
			</script>
			<%
			else
