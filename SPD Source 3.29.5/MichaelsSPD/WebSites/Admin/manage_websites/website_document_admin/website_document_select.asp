...
<frameset rows="30,1,1,*,1,1,30" border="0" frameborder="1" border="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0">
	<frame name="header" src="website_document_select_header.asp?itemType=<%=thisElementType%>&itemID=<%=thisElementID%>" scrolling="no" marginwidth="0" marginheight="0">
	...
	<frameset cols="240,*" bordercolor="cccccc" frameborder="1" framespacing=2 border="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0">
		<frameset rows="*,80" border="0" frameborder="0" border="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0">
			<frame name="tree" src="website_document_select_tree.asp?itemType=<%=thisElementType%>&itemID=<%=thisElementID%>" scrolling="auto">
			<frame name="finder" src="website_document_select_finder.asp" scrolling="no" marginwidth="0" marginheight="0">
		</frameset>
		<frame name="body" src="website_document_select_details_frm.asp?itemType=<%=thisElementType%>&itemID=<%=thisElementID%>" scrolling="auto" marginwidth="0" marginheight="0" >
	</frameset>
	...
	<frame name="controls" src="website_document_select_footer.asp?itemType=<%=thisElementType%>&itemID=<%=thisElementID%>" scrolling="no" marginwidth="0" marginheight="0" noresize>
</frameset>
</html>