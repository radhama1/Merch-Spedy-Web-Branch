...
<head>
	...
	function sortDetails(col_ordinal, sort_direction)
	{
		...
		parent.frames["DetailFrame"].document.location = "tax_wizard_list.asp?sort=" + col_ordinal + "&direction=" + sort_direction;
	}
...
<table cellpadding=0 cellspacing=0 border=0>
	<tr>
		<td><img src="./images/spacer.gif" height=1 width=5></td>
		<%=writeColHeader(0, "Tax UDA", true)%>
		<%=writeSeparatorBar()%>
		<%=writeColHeader(2, "Tax UDA Description", true)%>
		<%=writeSeparatorBar()%>
