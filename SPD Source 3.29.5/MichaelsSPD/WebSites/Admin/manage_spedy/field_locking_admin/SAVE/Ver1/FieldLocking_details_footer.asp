		...
		<td>
			<table width=100% cellpadding=0 cellspacing=0 border=0>
				<tr>
					...
					<td><img src="./../images/spacer.gif" height=1 width=5 border=0></td>
					<td><input type=button name="doSubmit2" value=" Save " onClick="javascript: void(0); doCommit('1');"></td>
					<td><img src="./../images/spacer.gif" height=1 width=5 border=0></td>
					<td><input type=button name="doSubmit2" value=" Save & Close " onClick="javascript: void(0); doCommit('0');"></td>
				</tr>
			</table>
		</td>
		<td><img src="./../images/spacer.gif" height=1 width=5 border=0></td>
