...
<html>
<head>
	<title>Custom Fields Frameset</title>
	<style type="text/css">
	<!--
		BODY
		{
	...
	%>
	<frameset id="CustomFieldsDetailsWrapperFrameset" rows="1,15,*,27,25" border="0" topmargin=0 leftmargin=0 rightmargin=0 bottommargin=0 marginheight=0 marginwidth=0>
		...
		<frame name="DetailFrame" src="custom_fields_detail.asp?tid=<%=Request("tid")%>" scrolling="yes" noresize><!-- Detail View Content -->
		<frame name="PagingNavFrame" src="../app_include/blank_cccccc.html" scrolling="no" frameborder=no noresize>
		<frame name="DetailOptionsFrame" src="custom_fields_detail_footer.asp?tid=<%=Request("tid")%>" scrolling="no" noresize>
	</frameset>
	<%
	Else
	%>
