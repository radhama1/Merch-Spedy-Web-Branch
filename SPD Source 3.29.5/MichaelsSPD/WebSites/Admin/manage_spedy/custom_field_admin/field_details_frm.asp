...
<html>
<head>
	<title><%if fieldID > 0 then%>Edit<%else%>New<%end if%> Field</title>
...
<frameset rows="50,1,1,*,1,1,30,0" border="0">
	...
	<frame name="body" src="field_details.asp?tid=<%=Record_ID%>&fid=<%=fieldID%>" scrolling="auto" marginwidth="0" marginheight="0" noresize>
