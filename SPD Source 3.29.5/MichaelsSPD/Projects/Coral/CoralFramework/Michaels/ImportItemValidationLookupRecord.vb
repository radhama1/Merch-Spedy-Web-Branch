...
Namespace Michaels
    ...
    Public Class ImportItemValidationLookupRecord
        ...
        Private _batchPackItemIndicator As String = String.Empty
        ...
        Public Property PackItemIndicator() As String
            ...
            End Set
        End Property
        Public Property BatchPackItemIndicator() As String
            Get
                Return _batchPackItemIndicator
            End Get
            Set(ByVal value As String)
                _batchPackItemIndicator = value
            End Set
        End Property
