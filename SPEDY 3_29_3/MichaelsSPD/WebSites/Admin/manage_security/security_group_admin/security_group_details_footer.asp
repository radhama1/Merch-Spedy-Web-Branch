...
<head>
	...
	<!--
		...
		function saveOnly()
		{
			...
			{
				parent.frames['body'].document.theForm.action = "security_group_details_work_noclose.asp";
		...
		function reloadParentFrame()
		{
			...
			var myFrameSetRef = new Object(parent.window.opener.parent.parent.frames['WorkspaceFrame'].frames['GroupDetailFrame']);
...
<script language=javascript>
	<%
	if Session.Value("SECURITYGROUP_SAVE_SUCCESS") <> "" then
	%>
