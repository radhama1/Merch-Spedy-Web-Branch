...
<head>
	...
	<!--
	    function doCancel() {
		    if ( parent.frames['body'].isDirty ) {
			    if (!confirm("Please confirm you wish to Discard your Changes and close window."))
				   return false;
			}
			parent.window.close();
		}
		...
		function EnableSaves() {
            ...
            document.theForm.btnCancel.value="Cancel";
		    return true;
		}
		
		function DisableSaves() {
            document.theForm.doSubmit1.disabled=true;
            document.theForm.doSubmit2.disabled=true;
            document.theForm.btnCancel.value="Close";
		    return false;
		}
	//-->
...
<body bgcolor="cccccc" link=0000ff vlink=0000ff topmargin=0 leftmargin=0 >
		...
		<td>
			<table width=100% cellpadding=0 cellspacing=0 border=0>
				<tr>
					...
					<td><input type=button name="btnCancel" id="btnCancel" value=" Close " onClick="javascript: void(0); doCancel();"></td>
					<td><img src="./../images/spacer.gif" height=1 width=5 border=0></td>
