...
<head>
	...
	<!--
		window.defaultStatus = "<%if boolIsNewContact then%>New<%else%>Edit<%end if%> User"
		...
		function preloadImgs()
		{
			...
			{		
				...
				notesTabImgOn = new Image(100, 12);
				notesTabImgOff = new Image(100, 12);
				...
				notesTabImgOn.src = "../images/tab_other_on.gif";
				notesTabImgOff.src = "../images/tab_other_off.gif";
		...
		//	alert(parent.frames['body'].name);
			switch (thisTabName)
			{
				...
				case "notesTab":
					parent.frames['body'].workspace_notes.style.display = "";
					document.images['notesTab'].src = notesTabImgOn.src;
					break;
		...
		function clearMenus()
		{
			...
			document.images['notesTab'].src = notesTabImgOff.src;
...
<table width=100% cellpadding=0 cellspacing=0 border=0 align=center>
	<tr bgcolor=333333><td colspan=2><img src="../images/editscreen_label_<%if boolIsNewContact then Response.Write "new" else Response.Write "edit" end if%>user.gif" height=25 width=125 border=0></td></tr>
	<tr>
		<td colspan=2>
			<table width=100% cellpadding=0 cellspacing=0 border=0>
				<tr bgcolor=333333>
					...
					<td><a href="javascript: void(0); clickMenu('notesTab')"><img name="notesTab" id="notesTab" src="../images/spacer.gif" height=12 width=100 border=0 alt="manage user notes"></a></td>
					<td><img src="../images/spacer.gif" height=1 width=4 border=0></td>
