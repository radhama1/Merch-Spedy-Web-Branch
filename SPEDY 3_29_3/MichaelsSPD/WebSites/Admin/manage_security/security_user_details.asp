...
<head>
	...
	<!--
		...
		{
			editWin = window.open("./security_user_admin/security_user_details_frm.asp?cid=" + RowID, "editWindow_" + RowID, "width=600,height=600,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=0");
			editWin.focus();
		}
