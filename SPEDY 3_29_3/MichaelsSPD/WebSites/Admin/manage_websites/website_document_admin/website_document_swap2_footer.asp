...
<head>
	...
	<!--
		function doCommit()
		{
			document.theForm.btnCommit.disabled=true;
			document.theForm.btnCancel.disabled=true;
			document.theForm.btnCommit.value='Working...';
			parent.frames['body'].frames['DetailFrame'].document.theForm.submit();
		}
	//-->
	</script>
</head>
