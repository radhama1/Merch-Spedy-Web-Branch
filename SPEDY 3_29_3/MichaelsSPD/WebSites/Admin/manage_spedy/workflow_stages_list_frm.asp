...
<frameset rows="1,15,*,27, 25" border="0" framespacing=0 topmargin=0 leftmargin=0 rightmargin=0 bottommargin=0 marginheight=0 marginwidth=0 frameborder=no>
	...
	<frame name="DetailFrame" src="workflow_stages_list.asp?id=<%=Request("id")%>" scrolling="yes"><!-- Detail View Content -->
	<frame name="PagingNavFrame" src="../app_include/blank_cccccc.html" scrolling="no" noresize frameborder=no>
	<frame name="DetailOptionsFrame" src="workflow_stages_list_footer.asp?id=<%=Request("id")%>" scrolling="no" noresize>
</frameset>
