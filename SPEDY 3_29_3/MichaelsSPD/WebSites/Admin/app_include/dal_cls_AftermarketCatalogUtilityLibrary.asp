<% 
'==============================================================================
' CLASS: cls_UtilityLibrary
' By ken.wallace
'==============================================================================
'
' This object holds global data access and conversion functions.
' Modify with care. KW
'
'==============================================================================
Class cls_AftermarketCatalogUtilityLibrary

	Public Function FormatDBStringForInsert(p_strIn)
		Dim strOut
		
		strOut = SmartValues(p_strIn, "CStr")
		strOut = Replace(strOut, "'", "''")
	
		FormatDBStringForInsert = strOut
	End Function

	Public Function FormatDBBoolsForInsert(p_strIn)
		Dim strOut
		
		strOut = SmartValues(SmartValues(p_strIn, "CBool"), "CInt")
	
		FormatDBBoolsForInsert = strOut
	End Function
	...
	Public Function loadXMLFromRS(p_strSQL, p_nodeName) ' Returns an MSXML2.DOMDocument
		...
		conn.Open Application.Value("AftermarketCatalogConnStr")
		stream.Open 
	...
	Public Function LoadRSFromDB(p_strSQL)
		...
		'response.Write p_strSQL & "<BR>"
		cmd.ActiveConnection  = Application.Value("AftermarketCatalogConnStr")
