<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POMaint.aspx.vb" Inherits="_POMaint" %>
...
<head id="Head1" runat="server">
	...
	<script language="javascript" type="text/javascript" src="include/PurchaseOrder/POMaint.js?v=<%=ConfigurationManager.AppSettings("AppVersion")%>"></script>
...
<div id="bodydiv" class="margin1" style="width: 100%;">
    ...
    <div class="gridTitle">
        <span class="caption">Purchase Order Maintenance Batches</span>
        <span class="floatLeft" >&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#" onclick="Search(); return false;">Search For Batch</a>
        </span>
        ...
        <div id="ItemSearch">
            ...
            <tr>
                <td align="right" width="5%" style="white-space:nowrap">
                    <span class="srchParm">PO Number:</span>
                </td>
                <td align="left" style="white-space:nowrap">
                    <novalibra:NLTextBox ID="srchPONumber" MaxLength="10" Width="60px" CssClass="srchTextMed textboxpad" runat="server"></novalibra:NLTextBox>
                </td>
                ...
                <td width="5%" align="right" valign="top" style="padding-top:6px; padding-left: 100px; white-space:nowrap">
            ...
            <tr>
                ...
                <td align="right" width="5%" style="white-space:nowrap">
                    <span class="srchParm">PO Status:</span>
                </td>
                <td  align="left" style="white-space:nowrap">
                    <asp:DropDownList ID="srchPOStatus" runat="server"></asp:DropDownList>                   
                </td>
            </tr>
            <tr>
                <td align="right" width="5%" style="white-space:nowrap">
            ...
            <asp:GridView ID="gvMaint"
                ...
                <Columns>
                    <asp:TemplateField  HeaderText="Vendor" SortExpression="1">
                        <ItemTemplate>
                            <a title="Show Purchase Order Details" href="POMaintHeader.aspx?POID=<%#Eval("ID")%>"><%#Eval("Vendor_Name")%><br /><%#Eval("Vendor_Number")%></a>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField  HeaderText="PO Number" SortExpression="10">
                        <ItemTemplate>
                            <a title="Show Purchase Order Details" href="POMaintHeader.aspx?POID=<%#Eval("ID")%>"><%#Eval("PO_Number")%></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Left" ForeColor="Black" />
                        <HeaderStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="B / S" SortExpression="11" >
                    ...
                    <asp:TemplateField HeaderText="Action" >
                        <ItemTemplate>
                            <asp:DropDownList ID="DDAction" runat="server" Width = "100px"></asp:DropDownList>
                            &nbsp;<asp:Button ID="DDActionGo" runat="server" Text="go" Width = "20px" CommandName="Action" />
                        </ItemTemplate>
