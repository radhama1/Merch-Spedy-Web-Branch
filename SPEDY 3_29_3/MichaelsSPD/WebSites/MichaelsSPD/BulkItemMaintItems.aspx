<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BulkItemMaintItems.aspx.vb" Inherits="BulkItemMaintItems" ValidateRequest="false" %>
...
<head id="Head1" runat="server">
    ...
    <title>Bulk Item Maintenance Items</title>
...
<script language="javascript" type="text/javascript" src="./BulkItemMaintItems.js"></script>
	...
	<div id="sitediv">
		<div id="bodydiv">
			...
			<div id="content">
						        ...
						        <td style="width: 10px;" valign="bottom">
						            ...
						            <tr>
						                <td style="height: 22px; white-space: nowrap;" valign="middle" align="left" nowrap="nowrap">
					                        ...
					                        <asp:HyperLink ID="linkExportBatchMaintFormat" runat="server" ToolTip="Export to Excel in Bulk Item Maintenance Format">Fast Sheet Export</asp:HyperLink>
						                </td>
						            </tr>
						            </table>
						        </td>
				...
				<div id="main">
					<ucgrid:NovaGrid ID="ItemGrid" GridID="7" runat="server" />
				</div>
			</div>
		</div>
	</div>
				        ...
				        <tr>
					        ...
					        <td valign="top" width="33%">
						        <table cellpadding=0 cellspacing=0 border=0>
							        ...
							        <tr>
								        <td>
									        <input type="checkbox" name="chk_EnabledCols" id="Checkbox1"<%If Not isUserDisabled Then%> disabled="disabled"<%End If%><%If Not isUserDisabled OrElse ColumnEnabledByUser(id, defaultDisplay) Then%> checked="checked"<%End If%> value="<%=id%>">
									        <%If Not isUserDisabled Then%><input type="hidden" name="chk_EnabledCols" value="<%=id%>"><%End If%>
								        </td>
								        <td class="bodyText" nowrap="nowrap"><label for="chk_EnabledCols_<%=id%>"><%=displayName%></label></td>
							        </tr>
