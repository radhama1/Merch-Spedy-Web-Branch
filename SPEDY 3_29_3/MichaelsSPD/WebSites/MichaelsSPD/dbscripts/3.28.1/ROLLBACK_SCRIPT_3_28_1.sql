...
--ROLLBACK VIEWS
--*******************
/****** Object:  View [dbo].[vwItemMaintItemDetail]    Script Date: 6/24/2024 3:09:41 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  View [dbo].[vwItemMaintItemDetailBySKU]    Script Date: 6/24/2024 3:10:10 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[sp_SPD_Batch_PublishMQMessage_ByBatchID]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_SPD_Import_Item_SaveRecord]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_SPD_Item_GetList]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_SPD_Item_SaveRecord]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[SPD_Report_CompletedDomesticItem]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[SPD_Report_CompletedImportItem]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SPD_Report_DomesticItem]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[SPD_Report_ImportItem]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_SPD_GetIMBatches_AllOther_PS]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[usp_SPD_GetIMBatches_Completed_PS]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[usp_SPD_GetIMBatches_MyItems_PS]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_SPD_GetNewItemBatches_AllOther_PS]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[usp_SPD_GetNewItemBatches_MyItems_PS]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[usp_SPD_ItemMaint_CompleteOrErrorBatch]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_SPD_MQComm_UpdateItemMaster]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_SPD_UpdateNewItemFromIM]    Script Date: 6/24/2024 3:17:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
set Display_Name = 'Fumigation Certificate'
...
update ColumnDisplayName set Display = 1 where column_name = 'CoinBattery'

update SPD_Item_Mapping set enabled = 0  where Mapping_name = 'DOMITEMHEADER' and Mapping_version = '16.75 Version'
 
update SPD_Item_Mapping set enabled = 0  where Mapping_name = 'DOMITEM' and Mapping_version = '16.75 Version'

update spd_item_mapping set enabled = 0 where mapping_name = 'IMPORTITEM' and mapping_version = '16.50'

update Validation_Rules set enabled = 0 where Validation_Document_ID = 1 and validation_rule = 'Phyto Temporary Shipment'

update Validation_Rules set enabled = 0 where Validation_Document_ID = 3 and validation_rule = 'Phyto Sanitary Certificate'

update Validation_Rules set enabled = 0 where Validation_Document_ID = 3 and validation_rule = 'Phyto Temporary Shipment'

update Validation_Rules set enabled = 0 where Validation_Document_ID = 4 and validation_rule = 'Phyto Temporary Shipment'
...
update Validation_Rules set enabled = 0 where Validation_Document_ID = 1 and validation_rule = 'Minimum Order Quantity'

update Validation_Rules set enabled = 0 where Validation_Document_ID = 1 and validation_rule = 'Product Identifies As Cosmetic'

update Validation_Rules set enabled = 0 where Validation_Document_ID = 4 and validation_rule = 'Minimum Order Quantity'

update Validation_Rules set enabled = 0 where Validation_Document_ID = 4 and validation_rule = 'Product Identifies As Cosmetic'

update Validation_Rules set Enabled = 0 where Validation_Document_ID = 4 and Validation_Rule = 'Vendor Order Minimum AMT'

update validation_rules set Enabled = 1 where Validation_Rule = 'TSSA' 
...
delete SPD_Field_Locking where Metadata_Column_ID = @TempShipIDIMP
...
delete SPD_Field_Locking where Metadata_Column_ID = @CertID

delete SPD_Field_Locking where Metadata_Column_ID = @TempShipID
...
delete SPD_Field_Locking where Metadata_Column_ID = @TempMaintShipID
...
delete SPD_Field_Locking where Metadata_Column_ID = @MOQFLNew
...
delete SPD_Field_Locking where Metadata_Column_ID = @PICFLNew
...
delete SPD_Field_Locking where Metadata_Column_ID = @MOQFLMaint
...
delete SPD_Field_Locking where Metadata_Column_ID = @PICFLMaint
...
update SPD_Metadata_Column set enabled = 0, FieldLocking_Enabled = 0, Validation_Enabled = 0, Maint_Editable =0, Send_To_RMS = 0  where Metadata_Table_ID = 1 and Column_Name = 'PhytoTemporaryShipment'
update SPD_Metadata_Column set enabled = 0, FieldLocking_Enabled = 0, Validation_Enabled = 0, Maint_Editable =0, Send_To_RMS = 0  where Metadata_Table_ID = 3 and Column_Name = 'PhytoSanitaryCertificate'
update SPD_Metadata_Column set enabled = 0, FieldLocking_Enabled = 0, Validation_Enabled = 0, Maint_Editable =0, Send_To_RMS = 0  where Metadata_Table_ID = 3 and Column_Name = 'PhytoTemporaryShipment'
update SPD_Metadata_Column set enabled = 0, FieldLocking_Enabled = 0, Validation_Enabled = 0, Maint_Editable =0, Send_To_RMS = 0  where Metadata_Table_ID = 11 and Column_Name = 'PhytoTemporaryShipment'
update SPD_Metadata_Column set enabled = 0, FieldLocking_Enabled = 0, Validation_Enabled = 0, Maint_Editable =0, Send_To_RMS = 0  where Metadata_Table_ID = 1 and Column_Name = 'MinimumOrderQuantity'
update SPD_Metadata_Column set enabled = 0, FieldLocking_Enabled = 0, Validation_Enabled = 0, Maint_Editable =0, Send_To_RMS = 0  where Metadata_Table_ID = 1 and Column_Name = 'ProductIdentifiesAsCosmetic'
update SPD_Metadata_Column set enabled = 0, FieldLocking_Enabled = 0, Validation_Enabled = 0, Maint_Editable =0, Send_To_RMS = 0  where Metadata_Table_ID = 11 and Column_Name = 'MinimumOrderQuantity'
update SPD_Metadata_Column set enabled = 0, FieldLocking_Enabled = 0, Validation_Enabled = 0, Maint_Editable =0, Send_To_RMS = 0  where Metadata_Table_ID = 11 and Column_Name = 'ProductIdentifiesAsCosmetic'