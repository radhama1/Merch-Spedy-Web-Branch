...
Partial Class pageheader
    ...
    Private _canDownloadImages As Boolean = False
    ...
    Public Property CanDownloadImages() As Boolean
        Get
            Return _canDownloadImages
        End Get
        Set(value As Boolean)
            _canDownloadImages = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If NovaLibra.Coral.Data.Security.Security.HasAccess("SPD.ADVANCED", "SPD.ADVANCED.IMAGEDOWNLOADER", Session("UserID")) Then
            ' imageDownloadLink.Visible = True
            imageDownloadLinkListItem.Visible = True
        Else
            ' imageDownloadLink.Visible = False
            imageDownloadLinkListItem.Visible = False
        End If
