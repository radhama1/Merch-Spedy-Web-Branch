<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POMaintenanceDetailsAddSKU.aspx.vb" Inherits="POMaintenanceDetailsAddSKU" %>
...
<head id="HTMLPageHead" runat="server">
    <title>Item Data Management: Add SKU</title>
	...
	<script type="text/javascript" language="javascript" src="POMaintenanceAddSKU.js"></script>
...
<body onload="SetControls();" >
    <div style="width:100%; margin-left:auto; margin-right:auto; overflow-x:hidden;">
		<form id="frmPOMaintenanceAddSKU" runat="server">
			...
			<div id="pageheader" runat="server">
				<uclayout:pageheader ID="headerControl" SendToDefault="true" runat="server" />
			</div>
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td style="padding-top:4px;">
										<a id="vendorLookUp" runat="server" href="#" onclick="GetVendorID();" title="Lookup Vendor Number">
											<img src="images/view.gif" alt="Lookup" border="0"/>
										</a>
									</td>
			...
			<asp:Panel ID="divResults" runat="server" CssClass="clearBoth">
                ...
                >
	                ...
	                <Columns>
						...
						<asp:BoundField DataField="Dept_Name" HeaderText="Dept. Name" HtmlEncode="False"
							SortExpression="3">
							<ItemStyle HorizontalAlign="Left" />
							<HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" />
						</asp:BoundField>
						<asp:BoundField DataField="Class_Num" HeaderText="Class<br />Number" HtmlEncode="False"
							SortExpression="4">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" VerticalAlign="Bottom" />
						</asp:BoundField>
						<asp:BoundField DataField="Sub_Class_Num" HeaderText="SubClass<br />Number" HtmlEncode="False"
							SortExpression="5">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" VerticalAlign="Bottom" />
						</asp:BoundField>
						...
						<asp:TemplateField HeaderText="Vendor Name" SortExpression="7">
							<ItemTemplate>
								<span>
									<%#Eval("Vendor_Name")%></span><span class="greenTextBold">&nbsp;<%#eval("VPI") %></span>
							</ItemTemplate>
							<HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" />
							<ItemStyle HorizontalAlign="Left" />
						</asp:TemplateField>
						<asp:BoundField DataField="Vendor_Style_Num" HeaderText="VPN" HtmlEncode="False"
							SortExpression="8">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" VerticalAlign="Bottom" />
						</asp:BoundField>
						<asp:TemplateField HeaderText="UPC" SortExpression="9">
							<ItemTemplate>
								<span>
									<%#eval("UPC") %></span><span class="greenTextBold">&nbsp;<%#eval("UPCPI") %></span>
							</ItemTemplate>
							<HeaderStyle HorizontalAlign="Left" VerticalAlign="Bottom" />
							<ItemStyle HorizontalAlign="Left" />
						</asp:TemplateField>
						<asp:BoundField DataField="Item_Status" HeaderText="Item<br />Status" HtmlEncode="False"
							SortExpression="10">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" VerticalAlign="Bottom" />
						</asp:BoundField>
						<asp:BoundField DataField="Stock_Category" HeaderText="Stock<br />Cat." HtmlEncode="False"
							SortExpression="11">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" VerticalAlign="Bottom" />
						</asp:BoundField>
						<asp:BoundField DataField="Item_Type_Attribute" HeaderText="Item<br />Attr." HtmlEncode="False"
							SortExpression="12">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" VerticalAlign="Bottom" />
						</asp:BoundField>
						<asp:BoundField DataField="Item_Type" HeaderText="Pack<br />Type" HtmlEncode="False"
							SortExpression="13">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" VerticalAlign="Bottom" />
						</asp:BoundField>
					...
					<PagerStyle BackColor="Black" ForeColor="White" Height="17px" HorizontalAlign="Center" />
					<PagerTemplate>
